...
}("undefined" != typeof window ? window : this, function (a, b)
{
	...
	n.event = {
		...
		mouseHooks:
		{
			...
			filter: function (a, b)
			{
				...
				return null == a.pageX && null != b.clientX && (c = a.target.ownerDocument || l, d = c.documentElement, e = c.body, a.pageX = b.clientX + (d && d.Left || e && e.Left || 0) - (d && d.clientLeft || e && e.clientLeft || 0), a.pageY = b.clientY + (d && d.Top || e && e.Top || 0) - (d && d.clientTop || e && e.clientTop || 0)), a.which || void 0 === f || (a.which = 1 & f ? 1 : 2 & f ? 3 : 4 & f ? 2 : 0), a
			}
		},
		fix: function (a)
		{
	...
	}, Kb.propHooks.Top = Kb.propHooks.Left = {
		set: function (a)
		{
	...
	}), n.each("blur focus focusin focusout load resize  unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function (a, b)
	{
		n.fn[b] = function (a, c)
		{
	...
	}, function (b, c)
	{
		...
		n.fn[b] = function (e)
		{
			...
			{
				var g = Jc(b);
				return void 0 === f ? g ? g[c] : b[e] : void(g ? g.To(d ? a.pageXOffset : f, d ? f : a.pageYOffset) : b[e] = f)
	...
	}, function (a, b)
	{
		...
		}, function (c, d)
		{
			n.fn[d] = function (d, e)
			{
				...
				{
					var e;
					return n.isWindow(b) ? b.document.documentElement["client" + a] : 9 === b.nodeType ? (e = b.documentElement, Math.max(b.body["" + a], e["" + a], b.body["offset" + a], e["offset" + a], e["client" + a])) : void 0 === d ? n.css(b, c, g) : n.style(b, c, d, g)
				}, b, f ? d : void 0, f, null)
			}
		})
	}), n.fn.size = function ()
	...
	function (t)
	{
		...
		function s(i, s, f, d, l, y)
		{
			...
			}, m.create = function (t, i)
			{
				...
				return Object.create ? o.prototype = Object.create(m.prototype) : e(o.prototype, m.prototype), o.prototype.constructor = o, o.defaults = e(
				{}, m.defaults), e(o.defaults, i), o.prototype.settings = {}, o.namespace = t, o.data = m.data, o.Item = function ()
				{
